...
client = MongoClient("mongodb+srv://maedan:dellPIPERtraining@cluster0.ibrn3.mongodb.net,cluster0.ibrn3.mongodb.net,cluster0.ibrn3.mongodb.net/?retryWrites=true&w=majority")
